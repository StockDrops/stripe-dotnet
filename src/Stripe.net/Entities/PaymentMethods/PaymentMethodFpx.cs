...
namespace Stripe
{
    ...
    public class PaymentMethodFpx : StripeEntity<PaymentMethodFpx>
    {
        ...
        /// <summary>
        /// The customer's bank, if provided. Can be one of <c>affin_bank</c>, <c>agrobank</c>,
        ...
        /// <c>standard_chartered</c>, <c>uob</c>, <c>deutsche_bank</c>, <c>maybank2e</c>, or
        /// <c>pb_enterprise</c>.
        /// One of: <c>affin_bank</c>, <c>agrobank</c>, <c>alliance_bank</c>, <c>ambank</c>,
        /// <c>bank_islam</c>, <c>bank_muamalat</c>, <c>bank_rakyat</c>, <c>bsn</c>, <c>cimb</c>,
        /// <c>deutsche_bank</c>, <c>hong_leong_bank</c>, <c>hsbc</c>, <c>kfh</c>, <c>maybank2e</c>,
